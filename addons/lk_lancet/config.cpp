...
class CfgVehicles
{
	...
	class lancet_base_F: UAV
	{
		...
		radarTargetSize=0.050000001;
		visualTargetSize=0.050000001;
		irTargetSize=0.050000001;
...
class Extended_InitPost_EventHandlers
{
	class lk_lancet
	{
		class lk_lancet_initpost_eh
		{
			clientInit="_this call lancet_fnc_init_lancet";
		};
	};
