...
private _maxDistance = if (count _retranslatorsNearUAV > 0 || count _retranslatorsNearPlayer > 0) then { 4000 } else { 1500 };
...
if (count _retranslatorsNearUAV > 0 || count _retranslatorsNearPlayer > 0) then {
